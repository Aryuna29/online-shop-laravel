...
Route::middleware('auth')->post('/product/{id}', [\App\Http\Controllers\ProductController::class, 'addReview'])->name('add.review');
...
Route::middleware('auth')->get('/user-order', [\App\Http\Controllers\OrderController::class, 'getUserOrder'])->name('userOrder');
